...
function (_React$Component2) {
  ...
  function StaticCard() {
    ...
    return _possibleConstructorReturn(this, _getPrototypeOf(StaticCard).apply(this, arguments));
  }
...
function (_React$Component3) {
  ...
  function FlipUnitContainer() {
    ...
    return _possibleConstructorReturn(this, _getPrototypeOf(FlipUnitContainer).apply(this, arguments));
  }
  ...
  _createClass(FlipUnitContainer, [{
    ...
    value: function render() {
      var _this$props3 = this.props,
          digit = _this$props3.digit,
          shuffle = _this$props3.shuffle,
          unit = _this$props3.unit,
          alias = _this$props3.alias,
          icoClockStyle = _this$props3.icoClockStyle,
          icoClockFlipStyle = _this$props3.icoClockFlipStyle,
          icoClockFlipTextStyle = _this$props3.icoClockFlipTextStyle,
          unitLabelContainerStyle = _this$props3.unitLabelContainerStyle,
          unitLabelTextStyle = _this$props3.unitLabelTextStyle;
      var now = digit;
...
function (_React$Component4) {
  ...
  function ShapeMilestone() {
    ...
    return _possibleConstructorReturn(this, _getPrototypeOf(ShapeMilestone).apply(this, arguments));
  }
  ...
  _createClass(ShapeMilestone, [{
    ...
    value: function render() {
      var _this$props4 = this.props,
          softcap = _this$props4.softcap,
          hardcap = _this$props4.hardcap,
          currentFund = _this$props4.currentFund,
          divType = _this$props4.divType,
          line = _this$props4.line,
          currency = _this$props4.currency,
          milestones = _this$props4.milestones,
          milestoneLineColor = _this$props4.milestoneLineColor;
...
function (_React$Component5) {
  ...
  function FundingProgress() {
    ...
    return _possibleConstructorReturn(this, _getPrototypeOf(FundingProgress).apply(this, arguments));
  }
  ...
  _createClass(FundingProgress, [{
    ...
    value: function render() {
      var _this$props5 = this.props,
          currentFund = _this$props5.currentFund,
          softcap = _this$props5.softcap,
          hardcap = _this$props5.hardcap,
          currency = _this$props5.currency,
          milestones = _this$props5.milestones,
          progressColor = _this$props5.progressColor,
          milestoneLineColor = _this$props5.milestoneLineColor,
          icoProgress = _this$props5.icoProgress;
...
function (_React$Component6) {
  ...
  function FundClockProgress(props) {
    ...
    _this = _possibleConstructorReturn(this, _getPrototypeOf(FundClockProgress).call(this, props));
    _this.state = {
      days: 0,
      daysShuffle: true,
      hours: 0,
  ...
  _createClass(FundClockProgress, [{
    ...
    value: function updateTime() {
      ...
      var _this$props6 = this.props,
          onTimerComplete = _this$props6.onTimerComplete,
          campaignEndDate = _this$props6.campaignEndDate;
    ...
    value: function render() {
      ...
      var _this$props7 = this.props,
          softcap = _this$props7.softcap,
          hardcap = _this$props7.hardcap,
          Milestones = _this$props7.Milestones,
          icoProgress = _this$props7.icoProgress,
          milestones = _this$props7.milestones;
...
FundClockProgress.defaultProps = {
  campaignEndDate: new Date(new Date().getFullYear(), new Date().getMonth(), new Date().getDate(), new Date().getHours(), new Date().getMinutes(), new Date().getSeconds() + 20).toString(),
  icoProgress: false,
  currentFund: 0,
  softcap: 0,
  hardcap: 0,
